...
try:
    ...
    print("Sklearn import failed - using fallback classes")
    SKLEARN_AVAILABLE = False
    
    # Mock classes for sklearn components
    class KFold:
        def __init__(self, *args, **kwargs): pass
        def split(self, X, y=None): return [(list(range(len(X)//2)), list(range(len(X)//2, len(X))))]
    ...
    def precision_score(y_true, y_pred, **kwargs): return 0.5
    def recall_score(y_true, y_pred, **kwargs): return 0.5
    def f1_score(y_true, y_pred, **kwargs): return 0.5
