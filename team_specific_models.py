...
class TeamSpecificPredictor:
    ...
    def get_team_adjustments(self, home_team_id, away_team_id, home_team_data=None, away_team_data=None):
        ...
        # FORM TRENDİ SABİT ÇARPANLARI KALDIRILDI
        # 0.1 sabit çarpanı kaldırıldı
        
        # SABİT ÇARPAN TAHMİN AYARLAMALARI KALDIRILDI
        adjustments = {
            # Sabit çarpan değerleri kaldırıldı
            "fixed_multipliers_removed": True,
