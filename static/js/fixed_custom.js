...
function updatePredictionUI(data) {
    ...
    // ********** TUTARSIZLIK DÜZELTME DEVRE DIŞI **********
    // Frontend override mekanizması kaldırıldı - API değerleri korunuyor
    console.log("API değerleri değiştirilmeden kullanılıyor - tutarlılık backend'de sağlanıyor");
...
function calculateBettingValuesFromScore(homeGoals, awayGoals) {
    ...
    const predictions = {
        // SABİT OLASILIK DEĞERLERİ TAMAMEN KALDIRILDI
        // Monte Carlo simülasyonu sonuçları korunuyor
    };
...
function updateBettingPredictions(bettingPredictions) {
    ...
    /* --- SKOR BAZLI SABİT OLASILIK DEĞERLERİ KALDIRILDI --- */
    
    // Toplam gol sayısını hesapla (sadece UI için)
    const totalGoals = scoreHomeGoals + scoreAwayGoals;
    
    // SABİT OLASILIK DEĞERLERİ KALDIRILDI
    // Monte Carlo simülasyonu sonuçları artık korunuyor
    // %85-90 gibi sabit değerler kaldırıldı
    console.log("Skor bazlı sabit olasılık override sistemi devre dışı - Monte Carlo sonuçları korunuyor");
